...
func _ready() -> void:
	...
	get_node("6").initialice("res://GameSrc/PatnicRoom/scenes/Gameloop/RestMode/Station/Station.tscn",ENUM.INPUT_REST.STATION.RETREAT)
	get_node("5").initialice("res://GameSrc/PatnicRoom/scenes/Gameloop/RestMode/Station/Station.tscn",ENUM.INPUT_REST.STATION.TERMINAL)
