...
onready var DesignManager = _Alecandria_Designer_AltManager.new()
...
func _ready() -> void:
	...
	if GameInit.isBrowseLecBootMode: changeMode(BrowserManager)
	if GameInit.isBrowseLecBootMode: changeMode(DesignManager)
