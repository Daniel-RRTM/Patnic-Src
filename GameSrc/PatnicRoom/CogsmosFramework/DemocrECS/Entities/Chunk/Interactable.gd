extends Entity
# DOCS  > Docs\API\docs\Cogsmos\democrECS\Interactable.md                      
# DOCS  > TO ADD                                                               
# BOOKMARK[epic=Entities] Interactable                                         
...
func typeToString()     -> String:     return ENUM.SOKRATILES.TYPES_ON_MAP.INTERACT
func type()             -> String:     return ENUM.SOKRATILES.TYPES_ON_MAP.INTERACT
