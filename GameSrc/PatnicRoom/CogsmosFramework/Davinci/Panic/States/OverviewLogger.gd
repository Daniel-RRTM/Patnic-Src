...
class_name _DavINCi_FSM_Panic_OverviewLogger


var sceneForInfopanel = "res://GameSrc/PatnicRoom/scenes/Gameloop/PanicMode/Subscenes/Sidepanel/News/News.tscn"

func _init() -> void:
	Signals.connect("animation_finished",self,"freeInfoPnale")
	validInputEnums = [ENUM.INPUT_PANIC.INFO.NEWS]
	typeEnum  = 1
