...
static func getComponents() -> Dictionary:
	return {
		
	"C_0_DESCRIPTION"					:	C_0_DESCRIPTION,
	"C_1_IS_WALKABLE"	              	:	C_1_IS_WALKABLE,
	"C_3_LAYER"             			: 	C_3_LAYER,
	"C_4_MAGIC_NOISE"       			: 	C_4_MAGIC_NOISE,
	...
	"C_28_RACIAL_FRIENDS"    			:   C_28_RACIAL_FRIENDS,
