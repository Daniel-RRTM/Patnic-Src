extends Node
class_name Statistics_Markdown_Hub
...
static func getStatistics() -> void:
	...
	var toParse = [
		...
		,{   "mode":"Quests"             ,   "array":API_001_Atlas.Quest().getEntries().keys()                 ,   "path":"/Docs/Wiki/Docs/Quests/Overview.md"               }
		,{   "mode":"LootFilter"         ,   "array":API_001_Atlas.LootFilter().getEntries().keys()            ,   "path":"/Docs/Wiki/Docs/LootFilter/Overview.md"           }
		,{   "mode":"Connections"        ,   "array":API_001_Atlas.Connection().getEntries().keys()             ,   "path":"/Docs/Wiki/Docs/Connections/Overview.md"          }
	...
	print("CREATING SYNTAX DOCS")
	
	#_Syntax_Parser_Overview.parse("consider")
